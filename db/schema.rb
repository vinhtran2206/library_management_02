...
ActiveRecord::Schema.define(version: 2019_02_11_034454) do
  ...
  create_table "borrow_details", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["borrow_id"], name: "index_borrow_details_on_borrow_id"
  end

  create_table "borrows", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "user_id"
    t.string "note"
    t.datetime "date_borrow", default: "2019-02-11 04:28:09"
    t.datetime "end_date_borrow", default: "2019-02-18 04:28:09"
  ...
  add_foreign_key "borrow_details", "books"
  add_foreign_key "borrow_details", "borrows"
